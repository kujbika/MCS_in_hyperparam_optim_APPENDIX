...
mn_optim <- function(parameter_values) {
  ...
  mn_seir_equations <- function(time, variables, parameters) {
    ...
    with(as.list(c(variables, parameters)), {
      ...
      return(list(c(dS, dI_S, dI, dS_Q, dE1, dE2, dE3, dI_A1,dI_A2,dI_A3, dI_S1,dI_S2,dI_S3, dI_A, dP_I1, dP_I2, dP_I3, dQ, dR, dK, dR_A)))
    })
  }
  initial_values <- c(
    S=19449999,
...
mn_pred <- function(parameter_values) {
  ...
  mn_seir_equations <- function(time, variables, parameters) {
    ...
    with(as.list(c(variables, parameters)), {
      ...
      dK <- -(K-min_contract_size)/lambda
      return(list(c(dS, dS_Q, dE1, dE2, dE3, dI_A1,dI_A2,dI_A3, dI_S1,dI_S2,dI_S3, dI_S, dI_A, dI, dP_I1, dP_I2, dP_I3, dQ, dR, dK, dR_A)))
    })
  }
  initial_values <- c(
    S=19449999,
